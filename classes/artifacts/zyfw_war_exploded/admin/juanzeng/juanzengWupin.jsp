...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           {
                 var url="<%=path %>/admin/juanzeng/wupinAdd.jsp";
                 //var n="";
                 //var w="480px";
                 //var h="500px";
	...
	<%--<form action="<%=path%>/juanzengMana.action" method="post">--%>
	    ...
	    <%--&nbsp;&nbsp;捐赠物品：<input type="text" name="xiangmu" value="${xiangmu}"/>--%>
	...
	<%--</form>--%>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
											...
											<td bgcolor="#FFFFFF" align="center"><s:property value="#juanzeng.type" /> </td>
											...
											<td bgcolor="#FFFFFF" align="center"><s:property value="#juanzeng.gj" /> </td>
											<td bgcolor="#FFFFFF" align="center"><s:property value="#juanzeng.jzyy" /> </td>
